...
HD_PWD='C:/Users/eryki/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_driver_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_driver_top.tcl
